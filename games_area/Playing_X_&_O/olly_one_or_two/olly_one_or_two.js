// X and O Game Mode Selection
console.log('Game mode selection loaded');
...
function selectMode(mode) {
    ...
    const selectedCard = document.querySelector(`.mode-card:nth-child(${mode === 'single' ? '1' : '2'})`);
...
function startGame(mode) {
    ...
    localStorage.setItem('vsAI', mode === 'single' ? 'true' : 'false');
    
    if (mode === 'single') {
        // Redirect to AI difficulty selection
        window.location.href = '../Levels_AI/Levels_AI.html';
    } else {
        // Redirect directly to multiplayer game
